...
4. **Rebuild the Entire Pipeline from Scratch**
   ...
   First, download the raw NYC TLC data into data/raw/:
    ...
    curl -o data/raw/yellow_tripdata_2024-02.parquet https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2024-02.parquet
    curl -o data/raw/yellow_tripdata_2024-03.parquet https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2024-03.parquet
    curl -o data/raw/taxi_zone_lookup.csv https://d37ci6vzurychx.cloudfront.net/misc/taxi_zone_lookup.csv
    ```
